  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-12">
      ...
      <div className="mt-8 space-y-6 leading-7 text-[var(--text-soft)]">
        ...
        <p>
          Vegan Masala participates in the Ethical Superstore and Spice Kitchen UK
          &amp; IE affiliate programmes through Awin and may also participate in
          programmes operated by selected food, grocery and kitchenware retailers.
          Where these links are present, the retailer is named and the link is
          identified as a paid affiliate link.
        </p>
      </div>
    </main>
  );
